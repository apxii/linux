...
static void rk3288_slp_mode_set(int level)
{
	 ...
	 * So if you care about security, put the regular sdmmc card-detect
	 * pin to ground, so it always thinks a card is present and use a
	 * different pin as gpio card-detect.
	 */
