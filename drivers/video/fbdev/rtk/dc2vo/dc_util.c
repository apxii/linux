...
EXPORT_SYMBOL(pli_IPCReadULONG);
...
EXPORT_SYMBOL(pli_IPCReadULONGLONG);
...
EXPORT_SYMBOL(pli_IPCWriteULONG);
...
EXPORT_SYMBOL(pli_IPCWriteULONGLONG);
...
EXPORT_SYMBOL(clkGetPresentation);
...
EXPORT_SYMBOL(clkResetPresentation);
